...
const Hero = () => {
	return (
		<section className='relative xl:px-[200px] lg:px-[150px] md:px-[100px] min-h-dvh text-white flex flex-col'>
			<Image
			...
			<div className='flex-1 h-full flex flex-col items-center justify-center gap-5'>
				<h1 className='2xl:text-[120px] xl:text-[100px] lg:text-[80px] md:text-[60px] tracking-tighter font-semibold leading-[1.05em] flex-wrap text-center opacity-90'>Ethiopia’s First Mentorship Platform</h1>
