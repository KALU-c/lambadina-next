...
import BookingSkeleton from "@/components/Dashboard/BookingSkeleton"
import { getMentorByAccessToken } from "@/actions/mentors"
import { MentorWithUser } from "../MentorDetail/PricingDesktop"
...
const DashboardDesktop = () => {
	...
	return (
		<main className="pt-[10px] flex flex-col">
			...
			<div className="px-[22px] flex flex-col space-y-6 mb-10 xl:px-[200px] lg:px-[150px] md:px-[50px]">
				<NavBarDesktop />
